...
<AccordionGroup>
  <Accordion title="Crop Service Failure">
    If cropping fails, the original image is used. Pipeline continues.
  </Accordion>

  <Accordion title="Search Enrichment Failure">
    If enrichment fails or confidence is low, only OCR data is saved. Pipeline continues.
  </Accordion>
</AccordionGroup>
...
<CardGroup cols={2}>
  <Card title="Instagram Product" icon="instagram">
    Upload screenshot of Instagram product post
  </Card>
  <Card title="E-commerce Page" icon="shopping-cart">
    Upload screenshot of product page
  </Card>
  <Card title="TikTok Product" icon="mobile-screen">
    Upload screenshot of TikTok product video
  </Card>
  <Card title="Web Product" icon="globe">
    Upload screenshot of any product webpage
  </Card>
</CardGroup>
...
- Learn about [Authentication](/api-reference/authentication) (coming soon)
- Check the [Architecture](/architecture) to understand the pipeline
- Explore [Services](/services/overview) for more details
