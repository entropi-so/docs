...
- Check [Environment variables](/configuration/environment-variables) for `SECRET_KEY` and JWT settings.
- See [`POST /pipeline/analyze`](/api-reference/analyze) for an example of an authenticated request.
