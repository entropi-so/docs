...
```python
from app.services.vision import prepare_image_for_ocr, analyze_capture
...
async def capture(file: UploadFile):
    ...
    # Now ready for the Vision Service
...
<Tip>
  The Vision Service handles the image encoding for the Gemini call, so you can pass the base64 string directly.
</Tip>

## Next Steps

- Learn about the [Vision Service](/services/vision-service) that uses this output
